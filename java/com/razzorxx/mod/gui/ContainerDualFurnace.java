...
import com.razzorxx.mod.recipe.DualFurnaceRecipes;
...
public class ContainerDualFurnace extends Container {
	...
	public ContainerDualFurnace(InventoryPlayer player, TileEntityDualFurnace tileentity) {
		...
		this.addSlotToContainer(new Slot(tileentity, 2, 80, 59));
		this.addSlotToContainer(new Slot(tileentity, 3, 80, 19));
