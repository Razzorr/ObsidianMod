package com.razzorxx.mod.blocks.obsidianwood;
...
public class CustomBlockPlanks extends Block implements IMetaName {
	...
	public static final PropertyEnum<EnumType> VARIANT = PropertyEnum.<CustomBlockPlanks.EnumType>create("variant", CustomBlockPlanks.EnumType.class);
